...
#### 1 - Introduction
- **Hello World** ([notebook](https://github.com/lev1khachatryan/Computer_Vision/tree/master/Tutorials/TensorFlow/notebooks/1_Introduction/helloworld.ipynb)) ([code](https://github.com/lev1khachatryan/Computer_Vision/tree/master/Tutorials/TensorFlow/examples/1_Introduction/helloworld.py)). Very simple example to learn how to print "hello world" using TensorFlow.
- **Basic Operations** ([notebook](https://github.com/lev1khachatryan/Computer_Vision/tree/master/Tutorials/TensorFlow/notebooks/1_Introduction/basic_operations.ipynb)) ([code](https://github.com/lev1khachatryan/Computer_Vision/tree/master/Tutorials/TensorFlow/examples/1_Introduction/basic_operations.py)). A simple example that cover TensorFlow basic operations.
- **TensorFlow Eager API basics** ([notebook](https://github.com/lev1khachatryan/Computer_Vision/tree/master/Tutorials/TensorFlow/notebooks/1_Introduction/basic_eager_api.ipynb)) ([code](https://github.com/lev1khachatryan/Computer_Vision/tree/master/Tutorials/TensorFlow/examples/1_Introduction/basic_eager_api.py)). Get started with TensorFlow's Eager API.
